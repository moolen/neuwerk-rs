...
Start here if you want to know what the firewall expects from its runtime environment.
...
- a release firewall binary built with the DPDK feature enabled
- the UI
- a vendored DPDK runtime under `/opt/neuwerk/runtime`
- launch and bootstrap scripts
- the systemd unit used to start the firewall correctly
...
If you use the image as intended, the service already grants what the firewall expects, including:
