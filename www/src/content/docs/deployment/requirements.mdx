...
If you are evaluating the product for the first time, begin with [Launch Neuwerk From The Released
Cloud Image](/docs/tutorials/launch-from-released-cloud-image). That is the primary onboarding path
for the shipped appliance image.
