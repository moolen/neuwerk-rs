...
- the firewall has TLS intercept CA material available
...
When interception is enabled, the firewall mints leaf certificates on demand from the intercept CA.
...
firewall does not actively block the request or response.
