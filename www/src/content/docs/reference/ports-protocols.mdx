...
description: Fixed listener ports and conditional runtime traffic used by the firewall.
order: 2
---

This page documents the ports that are fixed by the current runtime implementation.
