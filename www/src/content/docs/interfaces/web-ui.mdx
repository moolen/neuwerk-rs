---
title: Web UI
description: Shipped management UI, its page model, and how it talks to the control plane.
order: 2
---

This repository includes a real management web UI under `ui/`.
...
It is not a separate SPA deployment tier or a separate backend-for-frontend service.
...
Operationally, that means the management UI currently ships as part of the firewall runtime image,
not as a separately versioned deployable.
