...
- use [Customize The Appliance Image At First Boot](/docs/how-to/customize-the-appliance-image-at-first-boot) when your cloud rollout needs extra env vars, packages, files, or scripts at first boot
