...
The checked-in Vagrant workflow defaults to the `ubuntu-24.04-minimal-amd64` target so the demo box
...
The repository now includes [generate_vagrant_box_metadata.py](../../packaging/scripts/generate_vagrant_box_metadata.py)
