...
extern "C"
{
	...
	pub fn rust_rte_pktmbuf_pkt_len(m: *const rte_mbuf) -> u32;
	pub fn rust_rte_pktmbuf_data_len(m: *const rte_mbuf) -> u16;
	pub fn rust_rte_pktmbuf_nb_segs(m: *const rte_mbuf) -> u16;
