...
pub use dpdk_adapter::{DpdkAdapter, DpdkIo, FrameIo, UnwiredDpdkIo};
...
pub use wiretap::{WiretapEmitter, WiretapEvent, WiretapEventType, DEFAULT_WIRETAP_REPORT_INTERVAL_SECS};
