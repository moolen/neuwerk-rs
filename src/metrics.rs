...
pub struct MetricsInner {
    ...
    threat_matches: CounterVec,
    threat_alertable_matches: CounterVec,
    threat_feed_refresh: CounterVec,
    threat_feed_snapshot_age_seconds: GaugeVec,
    threat_feed_indicators: GaugeVec,
    threat_backfill_runs: CounterVec,
    ...
    dp_pending_tls_flow_count: Gauge,
    dp_flow_cap_rejections: Counter,
    dp_nat_cap_rejections: Counter,
    dp_pending_tls_cap_rejections: Counter,
    dp_source_group_flow_cap_rejections: Counter,
